...
contract VerifyAttestation {
    ...
    uint256 public constant fieldSize = 21888242871839275222246405745257275088696311157297823662689037894645226208583;
        ...
        )
    {
        ...
        (ticketIssuer, ticketId, conferenceId, commitment2, decodeIndex) = recoverTicketSignatureAddress(
            attestation,
            decodeIndex
        );
        ...
        // console.log("-----------");
        // console.logBytes(commitment1);
        // console.logBytes(commitment2);
    ...
    function recoverSignedIdentifierAddress(
        ...
        internal
        view
        returns (address signer, address subject, bytes memory commitment1, uint256 resultIndex, bool timeStampValid)
    {
