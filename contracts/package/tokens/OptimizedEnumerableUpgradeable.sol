...
contract OptimizedEnumerableUpgradeable is 
	OptimizedEnumerableBase,
	ERC721Upgradeable
{
	...
	function balanceOf(
		...
		view
		virtual
		override(OptimizedEnumerableBase, ERC721Upgradeable)
    ...
    function supportsInterface(
		...
		view
		virtual
		override(ERC721Upgradeable, OptimizedEnumerableBase)
		returns (bool)
	{
		return
